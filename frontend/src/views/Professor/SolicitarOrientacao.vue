...
async function solicitar(){
    ...
    form.emailProfessor = props?.emailProfessor;
    form.nomeAluno = props?.nomeAluno;

    if(!form.nomeAluno){
        return popupInfo().warning('Erro ao encontrar aluno, tente novamente mais tarde.');
    }
    if(!form.emailProfessor){
        return popupInfo().warning('Erro ao encontrar professor, tente novamente mais tarde.');
    }
    if(!form.aluno){
